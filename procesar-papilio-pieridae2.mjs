...
const CARPETAS = [
  { local: '/Users/housinsectsoffperu/Desktop/OPTIMIZADO  DE LA FAMILIA PAPILIONIDAE', folder: 'papilionidae-final' },
  { local: '/Users/housinsectsoffperu/Desktop/OPTIMIZADO DE LA FAMILIA PIERIDAE', folder: 'pieridae-final' },
  { local: '/Volumes/TOSHIBA EXT/CARPETAS HOUSEINSECTSOFPERU/pieridae para trabajar con fotoshop', folder: 'pieridae-final' },
]
...
for (const c of CARPETAS) {
  if (!fs.existsSync(c.local)) { console.log('⚠️ No existe: '+c.local); continue }
