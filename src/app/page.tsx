...
const CATALOGOS = [
  { id:1,  nombre:'Especímenes Biológicos Secos',                     descripcion:'Mariposas diurnas · Calidad A1 · CITES certificado',             video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561067/vid-especimenes.mp4',                       imagen:'/logo-house-insects-peru.png',  colorFondo:'rgba(10,30,10,0.85)',  ruta:'/catalogo/especimenes' },
  { id:2,  nombre:'CUADROS DE MARIPOSA TROPICAL SECOS',               descripcion:'Especies diurnas · Raras · Amazónicas',                        video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561070/vid-cuadros.mp4',                       imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558586/cat-cuadros.png',                                         colorFondo:'rgba(10,10,30,0.85)',  ruta:'/catalogo/diurnas' },
  { id:3,  nombre:'Joyería Natural',                                   descripcion:'Oro · Plata · Alas naturales · Artesanal',                       video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561072/vid-joyeria.mp4',                              imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558590/cat-joyeria.png', colorFondo:'rgba(30,20,0,0.85)',  ruta:'/catalogo/joyeria' },
  { id:4,  nombre:'Rarezas & Gynandromorphs',                         descripcion:'Piezas únicas · Aberraciones · Colección élite',                 video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561074/vid-rarezas.mp4',                                             imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558584/cat-rarezas.png',  colorFondo:'rgba(20,10,30,0.85)',  ruta:'/catalogo/rarezas' },
  { id:5,  nombre:'Artesanías & Cúpulas',                             descripcion:'Cuadros · Cúpulas · Resinas · Arte amazónico',                   video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561175/vid-artesanias.mp4',                              imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779559610/cat-artesanias.png',    colorFondo:'rgba(30,15,5,0.85)',   ruta:'/catalogo/artesanias' },
  { id:6,  nombre:'Herramientas Biológicas',                          descripcion:'Sets disección · Lupas binoculares · Kits montaje',              video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561076/vid-herramientas.mp4',                              imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558580/cat-herramientas.png',   colorFondo:'rgba(5,15,30,0.85)',   ruta:'/catalogo/herramientas' },
  { id:7,  nombre:'CUADRO DE MARIPOSAS NOCTURNAS TROPICAL',           descripcion:'Arctiidae · Saturnidae · Sphingidae · Uranidae · Amazónicas',    video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561177/vid-nocturnas.mp4',                                imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558582/cat-nocturnas.png',           colorFondo:'rgba(10,10,30,0.85)',  ruta:'/catalogo/nocturnas' },
  { id:8,  nombre:'Cuadros de Coleópteros & Artrópodos Tropicales',   descripcion:'Escarabajos · Arañas · Mantis · Calidad A1 · SERFOR',           video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561179/vid-coleopteros.mp4',                                  imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558588/cat-coleopteros.png',                     colorFondo:'rgba(20,10,5,0.85)',   ruta:'/catalogo/coleoptera' },
  { id:9,  nombre:'Minerales & Piedras Preciosas',                    descripcion:'Minerales peruanos · Piedras preciosas · Colección',             video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561181/vid-minerales.mp4',                                  imagen:'/categorias/mineerales_joyas.png',                                                   colorFondo:'rgba(5,20,30,0.85)',   ruta:'/catalogo/minerales' },
  { id:10, nombre:'Semillas & Plantas Medicinales',                   descripcion:'Flora amazónica · Medicinales · Orgánicas · SENASA',             video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561182/vid-semillas.mp4',                                  imagen:'/categorias/Semillas_y_flores.png',                                                  colorFondo:'rgba(5,20,10,0.85)',   ruta:'/catalogo/semillas' },
  { id:11, nombre:'Frutas Exóticas & Deshidratadas',                  descripcion:'Frutas amazónicas · Wild · Deshidratadas · SENASA',             video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561081/vid-frutas.mp4',                                          imagen:'/categorias/frutas__desidratdas.png',                                                colorFondo:'rgba(20,10,5,0.85)',   ruta:'/catalogo/frutas' },
  { id:12, nombre:'Hongos & Productos Naturales',                     descripcion:'Hongos amazónicos · Medicinales · Deshidratados',                video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561184/vid-hongos.mp4',                              imagen:'/categorias/Hongo__siolvester_wild.png',                                             colorFondo:'rgba(10,20,5,0.85)',   ruta:'/catalogo/hongos' },
  { id:13, nombre:'Textilería & Alpaca',                              descripcion:'Alpaca · Textilería amazónica · Artesanal',                      video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561082/vid-textileria.mp4',    imagen:'/categorias/Textrile_peruana_.png',                                                  colorFondo:'rgba(20,15,5,0.85)',   ruta:'/catalogo/textileria' },
  { id:14, nombre:'Alimentos Deshidratados',                          descripcion:'Condimentos amazónicos · Naturales · Sin preservantes',          video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561373/vid-alimentos-nuevo.mp4',    imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558595/cat-alimentos.png',                                                   colorFondo:'rgba(25,10,5,0.85)',   ruta:'/catalogo/alimentos' },
  { id:15, nombre:'Pinturas & Arte Rupestre',                         descripcion:'Arte amazónico · Pinturas naturales · Colección',                video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561186/vid-pinturas.mp4',                                    imagen:'/categorias/pinturea_arteanias.png',                                                  colorFondo:'rgba(20,10,15,0.85)',  ruta:'/catalogo/pinturas' },
  { id:16, nombre:'Maderas Finas & Esculturas',                       descripcion:'Maderas amazónicas · Esculturas · SERFOR certificado',           video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561086/vid-maderas.mp4', imagen:'/categorias/Madera__fine.png',                                                     colorFondo:'rgba(15,10,5,0.85)',   ruta:'/catalogo/maderas' },
  { id:17, nombre:'Esencias & Aceites Naturales',                     descripcion:'Aceites esenciales · Amazónicos · Medicinales',                  video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1779561187/vid-esencias.mp4',                                      imagen:'/categorias/Aceites__maderale.png',                                                  colorFondo:'rgba(20,5,15,0.85)',   ruta:'/catalogo/esencias' },
]
    ...
    <div style={{minHeight:'100vh',background:'#1A1209',fontFamily:'Georgia,serif'}}>
      ...
      <div style={{textAlign:'center',padding:'20px',borderTop:'1px solid rgba(201,168,76,0.15)'}}>
        <div style={{display:'flex',gap:20,justifyContent:'center',flexWrap:'wrap',marginBottom:10}}>
          <a href="/privacidad" className="home-footer-link" style={{color:'#C9A84C',fontSize:'.8rem',textDecoration:'none'}}>🔒 <ST t="Privacidad"/></a>
          ...
          <a href="/publicidad" className="home-footer-link" style={{color:"#C9A84C",fontSize:".8rem",textDecoration:"none"}}>📢 <ST t="Publicidad"/></a>
      ...
      <div style={{background:"rgba(0,0,0,0.3)",borderTop:"1px solid rgba(201,168,76,0.15)",padding:"24px 20px",textAlign:"center"}}>
        ...
        <div className="scroll-wrapper"><div className="scroll-track">{[{l:"SERFOR",s:"Reg. Forestal",c:"#2d6a2d",url:"https://www.serfor.gob.pe"},{l:"CITES",s:"Comercio Int.",c:"#1a4a7a",url:"https://cites.org"},{l:"SENASA",s:"Sanidad Agr.",c:"#7a2d1a",url:"https://www.senasa.gob.pe"},{l:"SUNAT",s:"RUC 20447397804",c:"#4a2d7a",url:"https://e-consultaruc.sunat.gob.pe"},{l:"FITOSAN.",s:"Certificado",c:"#2d5a3a",url:"https://www.senasa.gob.pe"},{l:"PROMPEX",s:"Export. Peru",c:"#8a2d00",url:"https://www.promperu.gob.pe"}].map(x=>(
            <a key={x.l} href={x.url||"#"} target="_blank" rel="noreferrer" style={{textDecoration:"none"}}><div className="badge-card" style={{background:x.c+"99",border:"1px solid "+x.c,borderRadius:"8px",padding:"8px 14px",textAlign:"center",minWidth:"80px"}}><p style={{color:"#fff",fontSize:".85rem",fontWeight:700,margin:0}}>{x.l}</p><p style={{color:"#ffffff",fontSize:".85rem",margin:"2px 0"}}>{x.s}</p><img src={"https://api.qrserver.com/v1/create-qr-code/?size=55x55&data="+encodeURIComponent(x.url||x.l)} alt="QR" style={{width:48,height:48,marginTop:4,borderRadius:4,display:"block",margin:"4px auto 0"}}/></div></a>
          ))}
        </div>
      </div>
