...
const CATALOGOS = [
  ...
  { id:7, nombre:'CUADRO DE MARIPOSAS NOCTURNAS TROPICAL', descripcion:'Arctiidae · Saturnidae · Sphingidae · Uranidae · Amazónicas', video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto/videos/cuadros_de_amriposas_nocturna_lsjw74.mp4', imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/NOCTURNSA-LOG2_nqnnth', colorFondo:'rgba(10,10,30,0.85)', ruta:'/catalogo/nocturnas' },
  ...
  { id:15, nombre:'Pinturas & Arte Rupestre', descripcion:'Arte amazónico · Pinturas naturales · Colección', video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto/videos/video_de_Pinturas_artes__1_kxly4a.mp4', imagen:'/categorias/pinturea_arteanias.png', colorFondo:'rgba(20,10,15,0.85)', ruta:'/catalogo/pinturas' },
  { id:16, nombre:'Maderas Finas & Esculturas', descripcion:'Maderas amazónicas · Esculturas · SERFOR certificado', video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto/videos/video_de_Pinturas_artes__1_kxly4a.mp4', imagen:'/categorias/Madera__fine.png', colorFondo:'rgba(15,10,5,0.85)', ruta:'/catalogo/maderas' },
  { id:17, nombre:'Esencias & Aceites Naturales', descripcion:'Aceites esenciales · Amazónicos · Medicinales', video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto/videos/aciete_y_yerbas_video_de_lqtqku.mp4', imagen:'/categorias/Aceites__maderale.png', colorFondo:'rgba(20,5,15,0.85)', ruta:'/catalogo/esencias' },
]
