...
const CATALOGOS = [
  ...
  { id:8,  nombre:'Cuadros de Coleópteros & Artrópodos Tropicales',   descripcion:'Escarabajos · Arañas · Mantis · Calidad A1 · SERFOR',           video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/Video_Minerales_y_joyeria__1_didueo.mp4',                                  imagen:'/categorias/marcos_de_de_diferente_colores_pa_ta_insectos.png',                     colorFondo:'rgba(20,10,5,0.85)',   ruta:'/catalogo/coleoptera' },
  ...
  { id:10, nombre:'Semillas & Plantas Medicinales',                   descripcion:'Flora amazónica · Medicinales · Orgánicas · SENASA',             video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/Video_Minerales_y_joyeria__1_didueo.mp4',                                  imagen:'/categorias/Semillas_y_flores.png',                                                  colorFondo:'rgba(5,20,10,0.85)',   ruta:'/catalogo/semillas' },
