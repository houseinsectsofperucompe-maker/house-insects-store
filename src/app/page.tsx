...
const CATALOGOS = [
  ...
  { id:2, nombre:'CUADROS DE MARIPOSA TROPICAL SECOS', descripcion:'Especies nocturnas · Raras · Amazónicas', video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/cazador_catlogo_mariposas_diurnas_vídeo_mp__j2nfez.mp4', imagen:'/categorias/Cuadros_butetrfly__diurne.png', colorFondo:'rgba(10,10,30,0.85)', ruta:'/catalogo/nocturnas' },
  ...
  { id:12, nombre:'Hongos & Productos Naturales', descripcion:'Hongos amazónicos · Medicinales · Deshidratados', video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/_frutas_exotica__desidratdas_seed_jxppwt.mp4', imagen:'/categorias/Hongo__siolvester_wild.png', colorFondo:'rgba(10,20,5,0.85)', ruta:'/catalogo/hongos' },
