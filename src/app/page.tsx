  ...
  return (
    <div style={{minHeight:'100vh',background:'#1A1209',fontFamily:'Georgia,serif'}}>
      ...
      <div style={{background:"rgba(0,0,0,0.2)",borderTop:"1px solid rgba(201,168,76,0.1)",padding:"24px 20px",textAlign:"center"}}>
        ...
        <div style={{display:"flex",gap:"10px",justifyContent:"center",flexWrap:"wrap"}}>
          {[{l:"FIRST BANK",s:"Transferencia",c:"#1a3a6a",i:"🏦",url:"https://www.firstbank.com.pe",qr:true},{l:"KATENOS",s:"Billetera",c:"#1a5a3a",i:"💳",url:"https://katenos.com",qr:true},{l:"IZIPAY",s:"Tarjetas",c:"#6a1a1a",i:"💰",url:"https://izipay.pe",qr:true},{l:"Google Pay",s:"G Pay",c:"#1a4a2a",i:"📱",url:"https://pay.google.com",qr:true},{l:"PAYONEER",s:"Internacional",c:"#c44a00",i:"🌐",url:"https://www.payoneer.com",qr:true},{l:"WISE",s:"Transfer.",c:"#163300",i:"💸",url:"https://wise.com",qr:false},{l:"LLOYDS",s:"London",c:"#0a2a5a",i:"🛡️",url:"https://www.lloyds.com",qr:true},{l:"SHIP INS.",s:"Maritimo",c:"#0a3a5a",i:"🚢",url:"https://shipinsurance.com",qr:true},{l:"INSURTECH",s:"Digital QR",c:"#2a0a5a",i:"📲",url:"https://insurtech.pe",qr:true}].map(x=>(<a key={x.l} href={x.url} target="_blank" rel="noreferrer" style={{textDecoration:"none"}}><div style={{background:x.c+"99",border:"1px solid "+x.c+"99",borderRadius:"8px",padding:"8px 14px",textAlign:"center",minWidth:"80px"}}><p style={{fontSize:"1rem",margin:0}}>{x.i}</p><p style={{color:"#fff",fontSize:".7rem",fontWeight:700,margin:0}}>{x.l}</p><p style={{color:"rgba(255,255,255,0.6)",fontSize:".55rem",margin:"2px 0"}}>{x.s}</p>{x.qr&&<img src={"https://api.qrserver.com/v1/create-qr-code/?size=60x60&data="+encodeURIComponent(x.url)} alt="QR" style={{width:50,height:50,marginTop:4,borderRadius:4}}/>}{!x.qr&&<p style={{color:"rgba(255,255,255,0.3)",fontSize:".5rem",margin:"4px 0"}}>disponible</p>}</div></a>))}
