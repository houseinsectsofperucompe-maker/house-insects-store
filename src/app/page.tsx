...
const CATALOGOS = [
  ...
  { id:6,  nombre:'Herramientas Biológicas',                          descripcion:'Sets disección · Lupas binoculares · Kits montaje',              video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1778854438/WhatsApp_Video_2026-05-15_at_08.40.28_vobsdz.mp4',                              imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558580/cat-herramientas.png',   colorFondo:'rgba(5,15,30,0.85)',   ruta:'/catalogo/herramientas' },
  { id:7,  nombre:'CUADRO DE MARIPOSAS NOCTURNAS TROPICAL',           descripcion:'Arctiidae · Saturnidae · Sphingidae · Uranidae · Amazónicas',    video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/cuadros_de_amriposas_nocturna_lsjw74.mp4',                                imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558582/cat-nocturnas.png',           colorFondo:'rgba(10,10,30,0.85)',  ruta:'/catalogo/nocturnas' },
