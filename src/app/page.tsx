...
const CSS = `
  ...
  .scroll-track{display:flex;animation:scrollX 30s linear infinite;width:max-content;gap:12px;padding:8px 0}.scroll-track:hover{animation-play-state:paused}.scroll-wrapper{overflow:hidden;width:100%;display:flex;justify-content:center}
