...
const CATALOGOS = [
  { id:1,  nombre:'Especímenes Biológicos Secos',                     descripcion:'Mariposas diurnas · Calidad A1 · CITES certificado',             video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/cazador_catlogo_mariposas_diurnas_vídeo_mp__j2nfez.mp4',                       imagen:'/logo-house-insects-peru.png',  colorFondo:'rgba(10,30,10,0.85)',  ruta:'/catalogo/especimenes' },
  { id:2,  nombre:'CUADROS DE MARIPOSA TROPICAL SECOS',               descripcion:'Especies nocturnas · Raras · Amazónicas',                        video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/Video_cuadros_Naturales_mariposas_diurnas__zl1n4f.mp4',                       imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558586/cat-cuadros.png',                                         colorFondo:'rgba(10,10,30,0.85)',  ruta:'/catalogo/nocturnas' },
  { id:3,  nombre:'Joyería Natural',                                   descripcion:'Oro · Plata · Alas naturales · Artesanal',                       video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1778854438/WhatsApp_Video_2026-05-15_at_08.40.48_sg6ybr.mp4',                              imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558586/cat-cuadros.png', colorFondo:'rgba(30,20,0,0.85)',  ruta:'/catalogo/joyeria' },
  { id:4,  nombre:'Rarezas & Gynandromorphs',                         descripcion:'Piezas únicas · Aberraciones · Colección élite',                 video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1778870094/house_insects_peru_intro_ujjmrv.mp4',                                             imagen:'/categorias/mineerales_joyas.png',  colorFondo:'rgba(20,10,30,0.85)',  ruta:'/catalogo/rarezas' },
  { id:5,  nombre:'Artesanías & Cúpulas',                             descripcion:'Cuadros · Cúpulas · Resinas · Arte amazónico',                   video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1778854438/WhatsApp_Video_2026-05-15_at_08.40.39_wnlddk.mp4',                              imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558588/cat-coleopteros.png',    colorFondo:'rgba(30,15,5,0.85)',   ruta:'/catalogo/artesanias' },
  { id:6,  nombre:'Herramientas Biológicas',                          descripcion:'Sets disección · Lupas binoculares · Kits montaje',              video:'https://res.cloudinary.com/dv3mvukmq/video/upload/v1778854438/WhatsApp_Video_2026-05-15_at_08.40.28_vobsdz.mp4',                              imagen:'/categorias/Semillas_y_flores.png',   colorFondo:'rgba(5,15,30,0.85)',   ruta:'/catalogo/herramientas' },
  { id:7,  nombre:'CUADRO DE MARIPOSAS NOCTURNAS TROPICAL',           descripcion:'Arctiidae · Saturnidae · Sphingidae · Uranidae · Amazónicas',    video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/cuadros_de_amriposas_nocturna_lsjw74.mp4',                                imagen:'/categorias/Hongo__siolvester_wild.png',           colorFondo:'rgba(10,10,30,0.85)',  ruta:'/catalogo/nocturnas' },
  { id:8,  nombre:'Cuadros de Coleópteros & Artrópodos Tropicales',   descripcion:'Escarabajos · Arañas · Mantis · Calidad A1 · SERFOR',           video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/video__cuadros_de_insectos_tropical_khdqy6.mp4',                                  imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558588/cat-coleopteros.png',                     colorFondo:'rgba(20,10,5,0.85)',   ruta:'/catalogo/coleoptera' },
  ...
  { id:14, nombre:'Alimentos Deshidratados',                          descripcion:'Condimentos amazónicos · Naturales · Sin preservantes',          video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/_video.__alimentos_en_polvo_y_desidratados_seed2321222942_ljdbcz.mp4',    imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/v1779558595/cat-alimentos.png',                                                   colorFondo:'rgba(25,10,5,0.85)',   ruta:'/catalogo/alimentos' },
