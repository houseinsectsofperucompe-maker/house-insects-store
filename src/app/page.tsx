...
const CATALOGOS = [
  { id:1,  nombre:'Especímenes Biológicos Secos',                     descripcion:'Mariposas diurnas · Calidad A1 · CITES certificado',             video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561067/vid-especimenes.mp4',                       imagen:'/logo-house-insects-peru.png',  colorFondo:'rgba(10,30,10,0.85)',  ruta:'/catalogo/especimenes' },
  { id:2,  nombre:'CUADROS DE MARIPOSA TROPICAL SECOS',               descripcion:'Especies nocturnas · Raras · Amazónicas',                        video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561070/vid-cuadros.mp4',                       imagen:'https://HouseInsects1967.b-cdn.net/image/upload/v1779558586/cat-cuadros.png',                                         colorFondo:'rgba(10,10,30,0.85)',  ruta:'/catalogo/nocturnas' },
  { id:3,  nombre:'Joyería Natural',                                   descripcion:'Oro · Plata · Alas naturales · Artesanal',                       video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561072/vid-joyeria.mp4',                              imagen:'https://HouseInsects1967.b-cdn.net/image/upload/v1779558590/cat-joyeria.png', colorFondo:'rgba(30,20,0,0.85)',  ruta:'/catalogo/joyeria' },
  { id:4,  nombre:'Rarezas & Gynandromorphs',                         descripcion:'Piezas únicas · Aberraciones · Colección élite',                 video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561074/vid-rarezas.mp4',                                             imagen:'https://HouseInsects1967.b-cdn.net/image/upload/v1779558584/cat-rarezas.png',  colorFondo:'rgba(20,10,30,0.85)',  ruta:'/catalogo/rarezas' },
  { id:5,  nombre:'Artesanías & Cúpulas',                             descripcion:'Cuadros · Cúpulas · Resinas · Arte amazónico',                   video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561175/vid-artesanias.mp4',                              imagen:'https://HouseInsects1967.b-cdn.net/image/upload/v1779559610/cat-artesanias.png',    colorFondo:'rgba(30,15,5,0.85)',   ruta:'/catalogo/artesanias' },
  { id:6,  nombre:'Herramientas Biológicas',                          descripcion:'Sets disección · Lupas binoculares · Kits montaje',              video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561076/vid-herramientas.mp4',                              imagen:'https://HouseInsects1967.b-cdn.net/image/upload/v1779558580/cat-herramientas.png',   colorFondo:'rgba(5,15,30,0.85)',   ruta:'/catalogo/herramientas' },
  { id:7,  nombre:'CUADRO DE MARIPOSAS NOCTURNAS TROPICAL',           descripcion:'Arctiidae · Saturnidae · Sphingidae · Uranidae · Amazónicas',    video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561177/vid-nocturnas.mp4',                                imagen:'https://HouseInsects1967.b-cdn.net/image/upload/v1779558582/cat-nocturnas.png',           colorFondo:'rgba(10,10,30,0.85)',  ruta:'/catalogo/nocturnas' },
  { id:8,  nombre:'Cuadros de Coleópteros & Artrópodos Tropicales',   descripcion:'Escarabajos · Arañas · Mantis · Calidad A1 · SERFOR',           video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561179/vid-coleopteros.mp4',                                  imagen:'https://HouseInsects1967.b-cdn.net/image/upload/v1779558588/cat-coleopteros.png',                     colorFondo:'rgba(20,10,5,0.85)',   ruta:'/catalogo/coleoptera' },
  { id:9,  nombre:'Minerales & Piedras Preciosas',                    descripcion:'Minerales peruanos · Piedras preciosas · Colección',             video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561181/vid-minerales.mp4',                                  imagen:'/categorias/mineerales_joyas.png',                                                   colorFondo:'rgba(5,20,30,0.85)',   ruta:'/catalogo/minerales' },
  { id:10, nombre:'Semillas & Plantas Medicinales',                   descripcion:'Flora amazónica · Medicinales · Orgánicas · SENASA',             video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561182/vid-semillas.mp4',                                  imagen:'/categorias/Semillas_y_flores.png',                                                  colorFondo:'rgba(5,20,10,0.85)',   ruta:'/catalogo/semillas' },
  { id:11, nombre:'Frutas Exóticas & Deshidratadas',                  descripcion:'Frutas amazónicas · Wild · Deshidratadas · SENASA',             video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561081/vid-frutas.mp4',                                          imagen:'/categorias/frutas__desidratdas.png',                                                colorFondo:'rgba(20,10,5,0.85)',   ruta:'/catalogo/frutas' },
  { id:12, nombre:'Hongos & Productos Naturales',                     descripcion:'Hongos amazónicos · Medicinales · Deshidratados',                video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561184/vid-hongos.mp4',                              imagen:'/categorias/Hongo__siolvester_wild.png',                                             colorFondo:'rgba(10,20,5,0.85)',   ruta:'/catalogo/hongos' },
  { id:13, nombre:'Textilería & Alpaca',                              descripcion:'Alpaca · Textilería amazónica · Artesanal',                      video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561082/vid-textileria.mp4',    imagen:'/categorias/Textrile_peruana_.png',                                                  colorFondo:'rgba(20,15,5,0.85)',   ruta:'/catalogo/textileria' },
  { id:14, nombre:'Alimentos Deshidratados',                          descripcion:'Condimentos amazónicos · Naturales · Sin preservantes',          video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561373/vid-alimentos-nuevo.mp4',    imagen:'https://HouseInsects1967.b-cdn.net/image/upload/v1779558595/cat-alimentos.png',                                                   colorFondo:'rgba(25,10,5,0.85)',   ruta:'/catalogo/alimentos' },
  { id:15, nombre:'Pinturas & Arte Rupestre',                         descripcion:'Arte amazónico · Pinturas naturales · Colección',                video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561186/vid-pinturas.mp4',                                    imagen:'/categorias/pinturea_arteanias.png',                                                  colorFondo:'rgba(20,10,15,0.85)',  ruta:'/catalogo/pinturas' },
  { id:16, nombre:'Maderas Finas & Esculturas',                       descripcion:'Maderas amazónicas · Esculturas · SERFOR certificado',           video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561086/vid-maderas.mp4', imagen:'/categorias/Madera__fine.png',                                                     colorFondo:'rgba(15,10,5,0.85)',   ruta:'/catalogo/maderas' },
  { id:17, nombre:'Esencias & Aceites Naturales',                     descripcion:'Aceites esenciales · Amazónicos · Medicinales',                  video:'https://HouseInsects1967.b-cdn.net/video/upload/v1779561187/vid-esencias.mp4',                                      imagen:'/categorias/Aceites__maderale.png',                                                  colorFondo:'rgba(20,5,15,0.85)',   ruta:'/catalogo/esencias' },
]
