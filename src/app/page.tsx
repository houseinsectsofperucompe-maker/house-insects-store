...
const CATALOGOS = [
  { id:1,  nombre:'Especímenes Biológicos Secos',                     descripcion:'Mariposas diurnas · Calidad A1 · CITES certificado',             video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/Video_cuadros_Naturales_mariposas_diurnas__zl1n4f.mp4',                       imagen:'https://res.cloudinary.com/dv3mvukmq/image/upload/logo-house-insects-peru_pvmkud',  colorFondo:'rgba(10,30,10,0.85)',  ruta:'/catalogo/especimenes' },
  ...
  { id:8,  nombre:'Cuadros de Coleópteros & Artrópodos Tropicales',   descripcion:'Escarabajos · Arañas · Mantis · Calidad A1 · SERFOR',           video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/video__cuadros_de_insectos_tropical_khdqy6.mp4',                                  imagen:'/categorias/marcos_de_de_diferente_colores_pa_ta_insectos.png',                     colorFondo:'rgba(20,10,5,0.85)',   ruta:'/catalogo/coleoptera' },
  { id:9,  nombre:'Minerales & Piedras Preciosas',                    descripcion:'Minerales peruanos · Piedras preciosas · Colección',             video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/video__cuadros_de_insectos_tropical_khdqy6.mp4',                                  imagen:'/categorias/mineerales_joyas.png',                                                   colorFondo:'rgba(5,20,30,0.85)',   ruta:'/catalogo/minerales' },
  { id:10, nombre:'Semillas & Plantas Medicinales',                   descripcion:'Flora amazónica · Medicinales · Orgánicas · SENASA',             video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/video__cuadros_de_insectos_tropical_khdqy6.mp4',                                  imagen:'/categorias/Semillas_y_flores.png',                                                  colorFondo:'rgba(5,20,10,0.85)',   ruta:'/catalogo/semillas' },
  { id:11, nombre:'Frutas Exóticas & Deshidratadas',                  descripcion:'Frutas amazónicas · Wild · Deshidratadas · SENASA',             video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/hongos_naturales_peru_xw47vq.mp4',                                          imagen:'/categorias/frutas__desidratdas.png',                                                colorFondo:'rgba(20,10,5,0.85)',   ruta:'/catalogo/frutas' },
  { id:12, nombre:'Hongos & Productos Naturales',                     descripcion:'Hongos amazónicos · Medicinales · Deshidratados',                video:'https://res.cloudinary.com/dv3mvukmq/video/upload/q_auto,f_auto/videos/hongos_naturales_peru.mp4',                              imagen:'/categorias/Hongo__siolvester_wild.png',                                             colorFondo:'rgba(10,20,5,0.85)',   ruta:'/catalogo/hongos' },
