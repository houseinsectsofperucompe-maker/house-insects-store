...
`}</style>
      <div className="pc" style={{maxWidth:1000,margin:'0 auto'}}>
        ...
        <div style={{textAlign:'center',marginBottom:32}}>
          ...
          <h1 style={{fontSize:'2rem',fontWeight:300,color:'#E8C97A',marginBottom:8}}><ST t="🍎 Frutas Exóticas, Agrícolas & Rodajas Deshidratadas"/></h1>
          ...
          <p style={{color:'rgba(232,201,122,0.6)',fontSize:'.85rem',lineHeight:1.9,maxWidth:700,margin:'0 auto'}}>
            Frutas amazónicas deshidratadas premium para coctelería fina, snacks saludables y lotes agrícolas. Certificadas SENASA para bares de lujo en Dubai, hoteles Europa y Asia.
          </p>
    ...
    <BannerSlot espacio='entre-productos' rubro='frutas' intervalo={7000}/>
    </div>
  )
}
