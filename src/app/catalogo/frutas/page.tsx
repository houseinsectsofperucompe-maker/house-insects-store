...
export default function FrutasPage() {
  ...
  const CATS = [
    {id:'todas',nm:'🍎 Todas'},
    {id:'mixology',nm:'🍋 Gourmet Mixology & Infusions'},
    {id:'snacks',nm:'🌿 Amazonian Super-Snacks'},
    {id:'bulk',nm:'📦 Bulk Exotic Raw Fruits'},
  ]
  const COLECCIONES = {
    mixology:[
      {icon:'🍋',nm:'Rodajas de Limón Deshidratado',desc:'Coctelería fina · Bares de lujo Dubai · Aromatización · Bolsas hermética'},
      {icon:'🍊',nm:'Rodajas de Naranja Deshidratada',desc:'Mixología · Infusiones · Decoración gourmet · Alta coctelería'},
      {icon:'🍈',nm:'Toronja & Lima Deshidratada',desc:'Rodajas perfectas · Esencias aromáticas · Hoteles Europa'},
      {icon:'🍍',nm:'Piña Deshidratada en Rodajas',desc:'Tropical · Coctelería exótica · Snack premium · Asia'},
    ],
    snacks:[
      {icon:'🫐',nm:'Aguaymanto Deshidratado',desc:'Superfood · Alto en vitamina C · Empaque hermético · Premium'},
      {icon:'🍌',nm:'Plátano Deshidratado',desc:'Snack natural · Sin preservantes · Amazónico · Orgánico'},
      {icon:'🥭',nm:'Mango Deshidratado',desc:'Variedad amazónica · Dulce natural · Exportación · Hermético'},
      {icon:'🌺',nm:'Camu Camu Deshidratado',desc:'Mayor vitamina C del mundo · Superfood · Polvo o trozos'},
      {icon:'🍈',nm:'Papaya Deshidratada',desc:'Tropical · Enzimas naturales · Snack saludable · Gourmet'},
    ],
    bulk:[
      {icon:'🌰',nm:'Castaña Amazónica Con Cáscara',desc:'Madre de Dios · Partida 0801.21.00.00 · Por kilo · SENASA'},
      {icon:'🥜',nm:'Castaña Amazónica Sin Cáscara',desc:'Madre de Dios · Partida 0801.22.00.00 · Premium · Seleccionada'},
      {icon:'📦',nm:'Lotes de Frutas Deshidratadas',desc:'Por kilos o sacos · Materia prima · Mayoreo · Factura incluida'},
    ],
  }
  const PARTIDAS: Record<string,{codigo:string,desc:string}> = {
    todas:{codigo:'0813.40.00.00',desc:'Frutas exóticas secas y deshidratadas · SENASA'},
    mixology:{codigo:'0813.40.00.00',desc:'Cítricos y frutas deshidratadas para coctelería · SENASA'},
    snacks:{codigo:'0813.40.00.00',desc:'Frutas tropicales deshidratadas amazónicas · SENASA'},
    bulk:{codigo:'0801.22.00.00',desc:'Castaña amazónica sin cáscara · SENASA · Madre de Dios'},
  }
  const piezasActuales = cat==='todas'
    ? [...COLECCIONES.mixology,...COLECCIONES.snacks,...COLECCIONES.bulk]
...
`}</style>
      <div className="pc" style={{maxWidth:1000,margin:'0 auto'}}>
        ...
        <div style={{textAlign:'center',marginBottom:32}}>
          ...
          <h1 style={{fontSize:'2rem',fontWeight:300,color:'#E8C97A',marginBottom:8}}><T t="🍎 Frutas Exóticas, Agrícolas & Rodajas Deshidratadas"/></h1>
          <div style={{height:1,background:'linear-gradient(to right,transparent,#C9A84C,transparent)',margin:'12px auto',maxWidth:400}}/>
          <p style={{color:'rgba(232,201,122,0.6)',fontSize:'.85rem',lineHeight:1.9,maxWidth:700,margin:'0 auto'}}><T t="Frutas amazónicas deshidratadas premium para coctelería fina, snacks saludables y lotes agrícolas. Certificadas SENASA para bares de lujo en Dubai, hoteles Europa y Asia."/></p>
