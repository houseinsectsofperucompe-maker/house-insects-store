      ...
      <div style={{maxWidth:480,margin:'0 auto',padding:'20px 16px'}}>
        ...
        <div style={{background:CARD,border:`1px solid ${BD}`,borderRadius:12,overflow:'hidden',marginBottom:16}}>
          ...
          >
            ...
            :<div style={{textAlign:'center',color:'rgba(201,168,76,0.25)',fontSize:'.7rem'}}><img src="https://res.cloudinary.com/dv3mvukmq/image/upload/w_120/logo-house-insects-peru_pvmkud" style={{width:120,opacity:0.3,marginBottom:8}}/><div style={{textTransform:'uppercase',letterSpacing:2,fontSize:'.65rem'}}>{v}</div><div style={{marginTop:4,fontSize:'.6rem'}}>PROXIMAMENTE</div></div>}
