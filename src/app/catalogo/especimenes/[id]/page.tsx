...
const FOTOS_BUNNY: Record<string, Record<string, string>> = {
  'Caligo eurilochus livius': {
    'Frente': 'https://housensectsperu.b-cdn.net/brassolidae/MS-BRA-EUR-A1M-cara-A.png',
    'Lado': 'https://housensectsperu.b-cdn.net/brassolidae/MS-BRA-EUR-A1M-lateral.png',
    'Reverso': 'https://housensectsperu.b-cdn.net/brassolidae/MS-BRA-EUR-A1M-reverso-V.png',
  }
}
