...
`}</style>
      <div className="pc" style={{maxWidth:1000,margin:'0 auto'}}>
        ...
        <div style={{textAlign:'center',marginBottom:32}}>
          ...
          <h1 style={{fontSize:'2rem',fontWeight:300,color:'#E8C97A',marginBottom:8}}><ST t="🗿 Peruvian Art & Heritage"/></h1>
    ...
    <BannerSlot espacio='entre-productos' rubro='artesanias' intervalo={7000}/>
    </div>
  )
}
