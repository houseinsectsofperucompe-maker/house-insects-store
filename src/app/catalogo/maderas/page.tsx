    ...
    <div style={{minHeight:'100vh',background:'#1A1209',fontFamily:'Georgia,serif',padding:'32px 16px'}}>
      ...
      <div className="page-content" style={{maxWidth:1200,margin:'0 auto'}}>
        ...
        <div style={{textAlign:'center',marginBottom:32}}>
          ...
          <h1 style={{fontSize:'1.8rem',fontWeight:300,color:'#E8C97A',marginBottom:4}}>🪵 Maderas Finas & Esculturas</h1>
        ...
        <div className="coming-card">
          ...
          <p style={{color:'rgba(232,201,122,0.4)',fontSize:'.8rem',marginBottom:24,letterSpacing:'.08em'}}>PRÓXIMAMENTE · Maderas amazónicas · Esculturas · SERFOR certificado</p>
