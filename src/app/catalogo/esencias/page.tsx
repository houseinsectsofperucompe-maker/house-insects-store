...
`}</style>
      <div className="pc" style={{maxWidth:1000,margin:'0 auto'}}>
        ...
        <div style={{textAlign:'center',marginBottom:32}}>
          ...
          <h1 style={{fontSize:'2rem',fontWeight:300,color:'#E8C97A',marginBottom:8}}><T t="🌸 Esencias, Aceites Naturales & Destilados de las 3 Regiones & Mar"/></h1>
          <div style={{height:1,background:'linear-gradient(to right,transparent,#C9A84C,transparent)',margin:'12px auto',maxWidth:400}}/>
          <p style={{color:'rgba(232,201,122,0.6)',fontSize:'.85rem',lineHeight:1.9,maxWidth:700,margin:'0 auto'}}><T t="Aceites esenciales puros de Palo Santo, Muña y flores amazónicas. Aceites cosméticos de Sacha Inchi y Jojoba. Extractos marinos antienvejecimiento de la costa peruana. Certificados DIGESA."/></p>
