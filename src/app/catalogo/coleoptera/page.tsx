...
`}</style>
      <div className="pc" style={{maxWidth:1000,margin:'0 auto'}}>
        ...
        <div style={{textAlign:'center',marginBottom:32}}>
          ...
          <div style={{color:'rgba(201,168,76,0.5)',fontSize:'.65rem',letterSpacing:'.2em',marginBottom:8}}>HOUSE INSECTS OF PERU  MS DE 40 AOS DE EXPERIENCIA</div>
          <h1 style={{fontSize:'2rem',fontWeight:300,color:'#E8C97A',marginBottom:8}}><ST t=" Cuadros de Colepteros & Artrpodos Tropicales Secos"/></h1>
          ...
          <p style={{color:'rgba(232,201,122,0.6)',fontSize:'.85rem',lineHeight:1.9,maxWidth:700,margin:'0 auto'}}>
            Escarabajos titn, hrcules, dinastidos metlicos, escorpiones, tarntulas y artrpodos amaznicos secos. Montados en marcos profundos, cpulas y resina para coleccionistas y museos de lite. Certificado SERFOR + CITES.
          </p>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:16}}>
          ...
          <div style={{background:'rgba(201,168,76,0.05)',border:'1px solid rgba(201,168,76,0.15)',borderRadius:12,padding:20}}>
            <div style={{color:'#C9A84C',fontSize:'.7rem',letterSpacing:'.1em',marginBottom:14}}> CONFIGURA TU CUADRO</div>
            ...
            <div style={{width:'100%',height:180,background:'linear-gradient(135deg,#1A1209,#2A1A08)',border:'2px solid rgba(201,168,76,0.25)',borderRadius:12,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',marginBottom:14}}>
              ...
              <p style={{color:'rgba(232,201,122,0.4)',fontSize:'.7rem'}}><ST t="FOTO PRXIMAMENTE"/></p>
            </div>
            ...
            {/* TAMANO */}
            <div style={{marginBottom:12}}>
              <div style={{color:'rgba(232,201,122,0.5)',fontSize:'.65rem',letterSpacing:'.08em',marginBottom:8}}> TAMAO (mm)</div>
            ...
            {/* MARCO */}
            <div style={{marginBottom:12}}>
              <div style={{color:'rgba(232,201,122,0.5)',fontSize:'.65rem',letterSpacing:'.08em',marginBottom:8}}>2 FORMATO DE EXHIBICIN</div>
              <div style={{display:'flex',gap:6,flexWrap:'wrap'}}>
                {[
                  {id:'rectangular',nm:' Marco Profundo'},
                  {id:'cupula',nm:' Cpula Victoriana'},
                  {id:'cubo',nm:' Cubo Cristal'},
                  {id:'resina',nm:' Resina Slida'},
                ].map(o=>(
            ...
            <div style={{marginBottom:14}}>
              <div style={{color:'rgba(232,201,122,0.5)',fontSize:'.65rem',letterSpacing:'.08em',marginBottom:8}}>3 TIPO DE PROTECCIN</div>
              <div style={{display:'flex',gap:6,flexWrap:'wrap'}}>
                {[
                  {id:'normal',nm:' Cristal Normal',extra:0},
                  {id:'uv',nm:' Cristal UV Premium',extra:20},
                ].map(o=>(
            ...
            <div style={{background:'rgba(201,168,76,0.08)',border:'1px solid rgba(201,168,76,0.2)',borderRadius:8,padding:12,marginBottom:14}}>
              <div style={{color:'#C9A84C',fontSize:'.7rem',fontWeight:700,marginBottom:6}}> TU CONFIGURACIN:</div>
              <div style={{color:'rgba(232,201,122,0.7)',fontSize:'.72rem',lineHeight:1.8}}>
                {tipo==='coleoptera'?' Coleptero':' Artrpodo'}  {tamano}<br/>
                 {marco==='rectangular'?'Marco Profundo':marco==='cupula'?'Cpula Victoriana':marco==='cubo'?'Cubo Cristal':'Resina Slida'}<br/>
                 {vidrio==='normal'?'Cristal Normal':'Cristal UV Premium'}
