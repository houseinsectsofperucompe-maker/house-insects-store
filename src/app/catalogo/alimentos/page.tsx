...
`}</style>
      <div className="pc" style={{maxWidth:1000,margin:'0 auto'}}>
        ...
        <div style={{textAlign:'center',marginBottom:32}}>
          ...
          <h1 style={{fontSize:'2rem',fontWeight:300,color:'#E8C97A',marginBottom:8}}><ST t="🌶️ Alimentos, Harinas Nativas & Especias de las 3 Regiones"/></h1>
          ...
          <p style={{color:'rgba(232,201,122,0.6)',fontSize:'.85rem',lineHeight:1.9,maxWidth:700,margin:'0 auto'}}>
            Café de especialidad, cacao orgánico, harinas nativas, ajíes exóticos, especias gourmet y plantas farmacéuticas de las 3 regiones del Perú. Certificados DIGESA y SENASA.
          </p>
    ...
    <BannerSlot espacio='entre-productos' rubro='alimentos' intervalo={7000}/>
    </div>
  )
}
