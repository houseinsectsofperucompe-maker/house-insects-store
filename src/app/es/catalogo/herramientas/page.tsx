  ...
  if (sel) return (
    <div style={{minHeight:'100vh',background:'#1A1209',fontFamily:'Georgia,serif',padding:'40px 20px'}}>
      ...
      <div style={{maxWidth:640,margin:'0 auto',textAlign:'center'}}>
        ...
        <a href={`mailto:houseinsectsofperu.com.pe@gmail.com?subject=Consulta: ${sel.nombre}`} style={{display:'block',marginTop:8,color:'#C9A84C',fontSize:'.82rem',textDecoration:'none'}}>houseinsectsofperu.com.pe@gmail.com</a>
      </div>
    </div>
  )
  return (
      ...
      <div style={{maxWidth:1200,margin:'0 auto'}}>
        ...
        {filtrados.length>0?(
          ...
          <div style={{textAlign:'center',padding:'50px 20px'}}>
            <p style={{color:'rgba(232,201,122,0.3)',marginBottom:8}}>{familia.especies.length===0?`Proximamente especies de ${familiaId}`:'No se encontraron especies'}</p>
