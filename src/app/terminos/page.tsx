...
`}</style>
      <div className="page-content" style={{maxWidth:800,margin:'0 auto'}}>
        ...
        <h1 style={{fontSize:'2rem',fontWeight:300,color:'#E8C97A',marginBottom:8}}>Terminos y Condiciones</h1>
        ...
        <p style={{fontSize:'.9rem',lineHeight:1.9,marginBottom:16}}>Todos nuestros especimenes son 100% legales, calidad A1, certificados SERFOR y CITES. Exportamos bajo Ley Amazonica N°27037.</p>

        <h2 style={{fontSize:'1.1rem',color:'#C9A84C',marginTop:24,marginBottom:8}}>2. Precios</h2>
        <p style={{fontSize:'.9rem',lineHeight:1.9,marginBottom:16}}>Precios en USD. Incluyen certificacion CITES y documentacion SERFOR. No incluyen envio internacional.</p>

        <h2 style={{fontSize:'1.1rem',color:'#C9A84C',marginTop:24,marginBottom:8}}>3. Envios Internacionales</h2>
        <p style={{fontSize:'.9rem',lineHeight:1.9,marginBottom:16}}>Exportamos via DHL, FedEx, UPS, Aramex, Exporta Facil, EMS Internacional y SERPOST. Tiempo estimado: 5-15 dias habiles. Incluimos documentacion aduanera completa.</p>

        <h2 style={{fontSize:'1.1rem',color:'#C9A84C',marginTop:24,marginBottom:8}}>4. Pagos</h2>
        <p style={{fontSize:'.9rem',lineHeight:1.9,marginBottom:16}}>Aceptamos los siguientes metodos de pago:</p>
        ...
        <p style={{fontSize:'.9rem',lineHeight:1.9,marginBottom:16}}>Garantizamos autenticidad y calidad A1. En caso de dano en transito, reemplazamos o reembolsamos previa documentacion fotografica.</p>

        <h2 style={{fontSize:'1.1rem',color:'#C9A84C',marginTop:24,marginBottom:8}}>6. Ley Aplicable</h2>
        <p style={{fontSize:'.9rem',lineHeight:1.9,marginBottom:16}}>Estos terminos se rigen por las leyes de la Republica del Peru. Jurisdiccion: Tingo Maria, Huanuco.</p>
      </div>
    </div>
  )
}
