...
function CheckoutForm() {
  ...
  useEffect(() => {
    ...
    style.innerHTML = '.kr-field-wrapper{background:#FFF8EE!important;border:2px solid #C9A84C!important;border-radius:8px!important;margin-bottom:12px!important}.kr-field-wrapper input{color:#1A1209!important;font-size:1rem!important;background:#FFF8EE!important}.kr-label{background:#3D2B0A!important;color:#E8C97A!important;font-size:.8rem!important;font-weight:700!important;padding:4px 8px!important;border-radius:6px 6px 0 0!important}.kr-payment-button{background:#2E7D32!important;color:white!important;font-weight:700!important;border-radius:8px!important;font-size:1rem!important}'
