...
`}</style>
      <div className="page-content" style={{maxWidth:800,margin:'0 auto'}}>
        ...
        <h1 style={{fontSize:'2rem',fontWeight:300,color:'#E8C97A',marginBottom:8}}><T t="📞 Contacto"/></h1>
        ...
        <h2 style={{fontSize:'1.1rem',color:'#C9A84C',marginTop:24,marginBottom:8}}><T t="WhatsApp"/></h2>
        ...
        <h2 style={{fontSize:'1.1rem',color:'#C9A84C',marginTop:24,marginBottom:8}}><T t="Email"/></h2>
        <p style={{fontSize:'.9rem',lineHeight:1.9,marginBottom:16}}>
        ...
        <h2 style={{fontSize:'1.1rem',color:'#C9A84C',marginTop:24,marginBottom:8}}><T t="Certificaciones"/></h2>
        ...
        <h2 style={{fontSize:'1.1rem',color:'#C9A84C',marginTop:24,marginBottom:8}}><T t="Horario"/></h2>
        ...
        <h2 style={{fontSize:'1.1rem',color:'#C9A84C',marginTop:24,marginBottom:8}}><T t="Idiomas"/></h2>
        <p style={{fontSize:'.9rem',lineHeight:1.9}}><T t="🇵🇪 Español · 🇺🇸 English · 🇩🇪 Deutsch · 🇫🇷 Français"/></p>
      </div>
    </div>
  )
}