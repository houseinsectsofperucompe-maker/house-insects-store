        ...
        <div>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:32}}>
            ...
            <div>
              ...
              <button onClick={()=>addItem({n:sel.n,p:sel.p,rubro:rubroId})} style={{width:'100%',padding:'12px',background:G,color:'#1A1209',border:'none',borderRadius:8,fontWeight:700,fontSize:'1rem',cursor:'pointer',fontFamily:'Georgia,serif',marginBottom:8}}>
                🛒 Agregar al carrito
              </button>
