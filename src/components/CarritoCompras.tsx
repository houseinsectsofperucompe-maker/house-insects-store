...
<div style={{background:'#062D8A',borderRadius:8,padding:12,marginBottom:8,textAlign:'center' as const}}>
  <p style={{color:'#fff',fontSize:'.75rem',fontWeight:'bold',margin:'0 0 8px'}}>📱 PLIN BBVA — Escanea y paga</p>
  <img src={'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data='+encodeURIComponent('PLIN|940699405|BBVA|JAVIER ZAVALA|'+total.toFixed(2)+'USD')}
    alt="QR Plin" style={{width:150,height:150,borderRadius:6,display:'block',margin:'0 auto 8px'}}/>
  <p style={{color:'rgba(255,255,255,0.8)',fontSize:'.7rem',margin:'0 0 4px'}}>Plin: <strong>940 699 405</strong> — BBVA</p>
