...
<a href={'https://wa.me/51940699405?text=Pago+QR+Total+$'+total.toFixed(2)+'+USD'} target="_blank" rel="noopener noreferrer" style={{display:'block',width:'100%',padding:'14px',background:'#128C7E',color:'white',borderRadius:8,fontWeight:700,fontSize:'1rem',fontFamily:'Georgia,serif',marginBottom:8,textAlign:'center',textDecoration:'none'}}><span style={{display:'flex',alignItems:'center',justifyContent:'center',gap:8}}><span>📱 Pagar con QR / WhatsApp</span><span style={{fontSize:'.75rem',opacity:0.85}}>+51 940 699 405</span><span style={{background:'rgba(255,255,255,0.2)',borderRadius:4,padding:'2px 6px',fontSize:'.65rem'}}>QR</span></span></a>
