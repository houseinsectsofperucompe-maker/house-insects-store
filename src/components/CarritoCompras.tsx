...
{paso==='pago'&&<>
<button onClick={pagar} disabled={loading} style={{width:'100%',padding:'14px',background:loading?'rgba(201,168,76,0.3)':G,color:BG,border:'none',borderRadius:8,fontWeight:700,fontSize:'1rem',cursor:loading?'not-allowed':'pointer',fontFamily:'Georgia,serif',marginBottom:8}}>{loading?'⏳ Procesando...':<span style={{display:'flex',alignItems:'center',justifyContent:'center',gap:8}}><span>💳 Pagar ${total.toFixed(2)} USD</span><span style={{display:'flex',gap:4,alignItems:'center'}}><span style={{background:'#1A1F71',color:'white',fontSize:'.55rem',fontWeight:'bold',padding:'2px 5px',borderRadius:3}}>VISA</span><span style={{background:'#EB001B',color:'white',fontSize:'.55rem',fontWeight:'bold',padding:'2px 5px',borderRadius:3}}>MC</span><span style={{background:'#2671C9',color:'white',fontSize:'.55rem',fontWeight:'bold',padding:'2px 5px',borderRadius:3}}>AMEX</span><span style={{background:'#fff',color:'#000',fontSize:'.55rem',fontWeight:'bold',padding:'2px 5px',borderRadius:3}}>G Pay</span></span></span>}</button>
<a href={'https://wa.me/51940699405?text=Pago+QR+Total+$'+total.toFixed(2)+'+USD'} target="_blank" rel="noopener noreferrer" style={{display:'block',width:'100%',padding:'14px',background:'#128C7E',color:'white',borderRadius:8,fontWeight:700,fontSize:'1rem',fontFamily:'Georgia,serif',marginBottom:8,textAlign:'center',textDecoration:'none'}}><span style={{display:'flex',alignItems:'center',justifyContent:'center',gap:8}}><span>Pagar</span><span style={{fontSize:'1.1rem'}}>▦</span><span style={{background:'rgba(255,255,255,0.2)',borderRadius:4,padding:'2px 6px',fontSize:'.65rem',fontWeight:'bold'}}>PLIN QR</span><span style={{background:'rgba(255,255,255,0.2)',borderRadius:4,padding:'2px 6px',fontSize:'.65rem',fontWeight:'bold'}}>Link Izipay</span><span style={{fontSize:'.75rem',opacity:0.85}}>+51 940 699 405</span></span></a>
