...
const CARPETAS = [
  { local: '/Volumes/TOSHIBA EXT/CARPETAS HOUSEINSECTSOFPERU/FOTO OPTIMIZADO DE LA FAMILIA LYCAENIDAE', folder: 'lycaenidae-final' },
  { local: '/Users/housinsectsoffperu/Desktop/FOTO OPTIMIZADO DE LA FAMILIA LYCAENIDAE', folder: 'lycaenidae-final' },
]
