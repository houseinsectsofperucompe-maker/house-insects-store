...
const CARPETAS = [
  { local: '/Users/housinsectsoffperu/Desktop/FOTOS OPTIMIZADO DE LA FAMILIA MORPHIDAE', folder: 'morphidae-final' },
]
...
for (const c of CARPETAS) {
  ...
  for (const f of files) {
    ...
    try {
      const r = await cloudinary.uploader.upload(path.join(c.local, f), {
